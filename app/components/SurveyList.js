...
function ServeyList() {
  return (
    ...
    <Page title="Survey List" menuSubHidden={true} rightMenu={true}>
            ...
            <div className="col-12">
              <div className="mb-2">
                ...
                <div className="top-right-button-container">
                  <button type="button" className="btn btn-primary btn-lg top-right-button mr-1" data-toggle="modal" data-backdrop="static" data-target="#exampleModalRight">
                    ADD NEW
                  </button>

                  <div className="modal fade modal-right" id="exampleModalRight" tabIndex="-1" role="dialog" aria-labelledby="exampleModalRight" aria-hidden="true">
              ...
              <div className="card d-flex flex-row mb-3">
                <div className="d-flex flex-grow-1 min-width-zero">
                  <div className="card-body align-self-center d-flex flex-column flex-md-row justify-content-between min-width-zero align-items-md-center">
                    <a className="list-item-heading mb-0 truncate w-40 w-xs-100 mt-0" href="Apps.Survey.html">
                      <i className="simple-icon-refresh heading-icon"></i>
                      <span className="align-middle d-inline-block">Developer Survey</span>
                    </a>
              ...
              <div className="card d-flex flex-row mb-3">
                <div className="d-flex flex-grow-1 min-width-zero">
                  <div className="card-body align-self-center d-flex flex-column flex-md-row justify-content-between min-width-zero align-items-md-center">
                    <a className="list-item-heading mb-0 truncate w-40 w-xs-100 mt-0" href="Apps.Survey.html">
                      <i className="simple-icon-refresh heading-icon"></i>
                      <span className="align-middle d-inline-block">Designer Survey</span>
                    </a>
                ...
                <div className="d-flex flex-grow-1 min-width-zero">
                  <div className="card-body align-self-center d-flex flex-column flex-md-row justify-content-between min-width-zero align-items-md-center">
                    <a className="list-item-heading mb-0 truncate w-40 w-xs-100 mt-0" href="Apps.Survey.html">
                      ...
                      <span className="align-middle d-inline-block">Backend Survey</span>
                    </a>
                    <p className="mb-0 text-muted text-small w-15 w-xs-100">Store</p>
