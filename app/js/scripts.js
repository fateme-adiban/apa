...
`
  ...
  $("#switchDark").on("change", function (e) {
    if (theme.includes("dark")) $("#switchDark").prop("checked", false)
    var mode = $("#switchDark").prop("checked") ? "dark" : "light"
    if (mode == "dark") {
  ...
  $(document).on("click", function (event) {
    if (!($(event.target).parents().hasClass("theme-colors") || $(event.target).parents().hasClass("theme-button") || $(event.target).hasClass("theme-button") || $(event.target).hasClass("theme-colors"))) {
